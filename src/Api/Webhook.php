...
class Webhook
{
     ...
     * @see  https://godocs.unisender.ru/web-api-ref#webhook-set
     */
   ...
   * @return array           API response
   * @throws GuzzleException
   * @see  https://godocs.unisender.ru/web-api-ref#webhook-get
   */
   ...
   * @return array           API response
   * @throws GuzzleException
   * @see  https://godocs.unisender.ru/web-api-ref#webhook-list
   */
   ...
   * @return array           API response
   * @throws GuzzleException
   * @see  https://godocs.unisender.ru/web-api-ref#webhook-delete
   */
  ...
  public function verify(string $body): bool
  {
      ...
      // See: https://godocs.unisender.ru/web-api-ref#callback-format
